...
Automatically enforce metric thresholds on pull requests to prevent quality regressions.

## How Quality Gates Work

Quality gates compare metrics from your pull request against the baseline from your main branch. Unentropy evaluates them automatically:
